...
public interface CallPrx extends com.zeroc.Ice.ObjectPrx
{
     ...
     **/
    static CallPrx checkedCast(com.zeroc.Ice.ObjectPrx obj)
    {
        return com.zeroc.Ice.ObjectPrx._checkedCast(obj, ice_staticId(), CallPrx.class, _CallPrxI.class);
    }
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     **/
    static CallPrx checkedCast(com.zeroc.Ice.ObjectPrx obj, java.util.Map<String, String> context)
    {
        return com.zeroc.Ice.ObjectPrx._checkedCast(obj, context, ice_staticId(), CallPrx.class, _CallPrxI.class);
    }
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     **/
    static CallPrx checkedCast(com.zeroc.Ice.ObjectPrx obj, String facet)
    {
        return com.zeroc.Ice.ObjectPrx._checkedCast(obj, facet, ice_staticId(), CallPrx.class, _CallPrxI.class);
    }
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     **/
    static CallPrx checkedCast(com.zeroc.Ice.ObjectPrx obj, String facet, java.util.Map<String, String> context)
    {
        return com.zeroc.Ice.ObjectPrx._checkedCast(obj, facet, context, ice_staticId(), CallPrx.class, _CallPrxI.class);
    }
     ...
     **/
    static CallPrx uncheckedCast(com.zeroc.Ice.ObjectPrx obj)
    {
        return com.zeroc.Ice.ObjectPrx._uncheckedCast(obj, CallPrx.class, _CallPrxI.class);
    }
     ...
     * @return A proxy for this type.
     **/
    static CallPrx uncheckedCast(com.zeroc.Ice.ObjectPrx obj, String facet)
    {
        return com.zeroc.Ice.ObjectPrx._uncheckedCast(obj, facet, CallPrx.class, _CallPrxI.class);
    }
     ...
     **/
    @Override
    default CallPrx ice_context(java.util.Map<String, String> newContext)
    {
        return (CallPrx)_ice_context(newContext);
    }
     ...
     **/
    @Override
    default CallPrx ice_adapterId(String newAdapterId)
    {
        return (CallPrx)_ice_adapterId(newAdapterId);
    }
     ...
     **/
    @Override
    default CallPrx ice_endpoints(com.zeroc.Ice.Endpoint[] newEndpoints)
    {
        return (CallPrx)_ice_endpoints(newEndpoints);
    }
     ...
     **/
    @Override
    default CallPrx ice_locatorCacheTimeout(int newTimeout)
    {
        return (CallPrx)_ice_locatorCacheTimeout(newTimeout);
    }
     ...
     **/
    @Override
    default CallPrx ice_invocationTimeout(int newTimeout)
    {
        return (CallPrx)_ice_invocationTimeout(newTimeout);
    }
     ...
     **/
    @Override
    default CallPrx ice_connectionCached(boolean newCache)
    {
        return (CallPrx)_ice_connectionCached(newCache);
    }
     ...
     **/
    @Override
    default CallPrx ice_endpointSelection(com.zeroc.Ice.EndpointSelectionType newType)
    {
        return (CallPrx)_ice_endpointSelection(newType);
    }
     ...
     **/
    @Override
    default CallPrx ice_secure(boolean b)
    {
        return (CallPrx)_ice_secure(b);
    }
     ...
     **/
    @Override
    default CallPrx ice_encodingVersion(com.zeroc.Ice.EncodingVersion e)
    {
        return (CallPrx)_ice_encodingVersion(e);
    }
     ...
     **/
    @Override
    default CallPrx ice_preferSecure(boolean b)
    {
        return (CallPrx)_ice_preferSecure(b);
    }
     ...
     **/
    @Override
    default CallPrx ice_router(com.zeroc.Ice.RouterPrx router)
    {
        return (CallPrx)_ice_router(router);
    }
     ...
     **/
    @Override
    default CallPrx ice_locator(com.zeroc.Ice.LocatorPrx locator)
    {
        return (CallPrx)_ice_locator(locator);
    }
     ...
     **/
    @Override
    default CallPrx ice_collocationOptimized(boolean b)
    {
        return (CallPrx)_ice_collocationOptimized(b);
    }
     ...
     **/
    @Override
    default CallPrx ice_twoway()
    {
        return (CallPrx)_ice_twoway();
    }
     ...
     **/
    @Override
    default CallPrx ice_oneway()
    {
        return (CallPrx)_ice_oneway();
    }
     ...
     **/
    @Override
    default CallPrx ice_batchOneway()
    {
        return (CallPrx)_ice_batchOneway();
    }
     ...
     **/
    @Override
    default CallPrx ice_datagram()
    {
        return (CallPrx)_ice_datagram();
    }
     ...
     **/
    @Override
    default CallPrx ice_batchDatagram()
    {
        return (CallPrx)_ice_batchDatagram();
    }
     ...
     **/
    @Override
    default CallPrx ice_compress(boolean co)
    {
        return (CallPrx)_ice_compress(co);
    }
     ...
     **/
    @Override
    default CallPrx ice_timeout(int t)
    {
        return (CallPrx)_ice_timeout(t);
    }
     ...
     **/
    @Override
    default CallPrx ice_connectionId(String connectionId)
    {
        return (CallPrx)_ice_connectionId(connectionId);
    }
     ...
     **/
    @Override
    default CallPrx ice_fixed(com.zeroc.Ice.Connection connection)
    {
        return (CallPrx)_ice_fixed(connection);
    }
